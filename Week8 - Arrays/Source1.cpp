...
int main() 
{
	...
	cout << "Employee infor for seven." << endl;

	for (int i = 0; i < indexElemtent; i++) 
	{
		cout << "Employee " << i << " worked " << employee[i].getHourlyPay() << " hours." << endl;

		cout << "Employee " << " gets payed $" << employee[i].getPayRate() << " per hours." << endl;

		cout << "Employee " << " grows pay is $" << employee[i].grossPay() << "  ." << endl;
